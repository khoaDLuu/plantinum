...
# To test the network from terminal, make sure you are at rpi-dp/leaveprob-dttor/, if not cd there and run:
# python network_testing.py --model plantcondition.model --image test/test.jpg
